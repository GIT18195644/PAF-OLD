...
<html lang="en">
	<head>
		<title>Administrator | Doctor Specialization</title>
						...
						<tbody>
							<tr>
								...
								<td ><div class="visible-md visible-lg hidden-sm hidden-xs">
							 	...
							 	<a href="edit-doctor-specialization.jsp" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
