...
<html lang="en">
	<head>
		<title>Accountant Login | Ayurwedha Health Care Center</title>
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
					<h2> Ayurwedha | Accountant Login</h2>
				</div>
					...
					<form class="form-login" action="dashboard.jsp" method="post">
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="test" class="form-control password" name="password" placeholder="Password">
							...
							<div class="form-actions">
								...
								<button type="reset" class="btn btn-primary pull-right" name="submit">
